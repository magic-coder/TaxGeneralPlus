...
-(id)initWithTitles:(NSArray *)titles{
    ...
    return [self initWithTitles:titles withButtonHeight:40.0f withMenuColor:[UIColor colorWithRed:66.0f/255.0f green:138.0f/255.0f blue:247.0f/255.0f alpha:1.0f] withBackBlurStyle:UIBlurEffectStyleDark];
}
