...
- (void)addSearchBar {
    // 添加搜索框
    UITextField *searchTextField = [[UITextField alloc] initWithFrame:CGRectMake(20, HEIGHT_STATUS+10, WIDTH_SCREEN - 15 - 60, 26)];
...
- (void)addHandleButton {
    ...
    btn_edit.frame = CGRectMake(WIDTH_SCREEN-50, HEIGHT_STATUS+2, 46, 46);
    ...
    CGFloat btnW = floorf((CGFloat)(WIDTH_SCREEN - 50)/4);
    
    UIButton *btn_1 = [UIButton buttonWithType:UIButtonTypeCustom];
    btn_1.frame = CGRectMake(10, self.frame.size.height-85, btnW, 80);
    ...
    btn_2.frame = CGRectMake(btn_1.frameRight+10, self.frame.size.height-85, btnW, 80);
    ...
    btn_3.frame = CGRectMake(btn_2.frameRight+10, self.frame.size.height-85, btnW, 80);
    ...
    btn_4.frame = CGRectMake(btn_3.frameRight+10, self.frame.size.height-85, btnW, 80);
